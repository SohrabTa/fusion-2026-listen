...
function embed(link){
  ...
  if(link.platform==='soundcloud'&&/(^|\\/\\/)(www\\.)?soundcloud\\.com\\//.test(u))
    return '<iframe height="'+(link.kind==='profile'?166:120)+'" src="https://w.soundcloud.com/player/?url='+encodeURIComponent(u.replace(/www\\.soundcloud\\.com/i,'soundcloud.com'))+'&color=%23ff5500&auto_play=true&show_comments=false&visual=false" loading="lazy"></iframe>';
